...
const Rust: React.FC<IconProps> = ({ size = 16, color = 'currentColor', ...props }) => {
    return (
        <svg version="1.1" height={size} width={size} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 106 106" {...props}>
        <g id="logo" transform="translate(53, 53)">
                <path id="r" transform="translate(0.5, 0.5)" stroke={color} fill={color} strokeWidth="1" strokeLinejoin="round" d="     M -9,-15 H 4 C 12,-15 12,-7 4,-7 H -9 Z     M -40,22 H 0 V 11 H -9 V 3 H 1 C 12,3 6,22 15,22 H 40     V 3 H 34 V 5 C 34,13 25,12 24,7 C 23,2 19,-2 18,-2 C 33,-10 24,-26 12,-26 H -35     V -15 H -25 V 11 H -40 Z"/>
                <g id="gear" mask="url(#holes)">
                    <circle r="43" fill="none" stroke={color} strokeWidth="9"/>
                    <g id="cogs">
                        <polygon id="cog" stroke={color} fill={color} strokeWidth="3" strokeLinejoin="round" points="46,3 51,0 46,-3"/>
                    ...
                    <g id="mounts">
                        <polygon id="mount" stroke={color} strokeWidth="6" strokeLinejoin="round" points="-7,-42 0,-35 7,-42"/>
