...
const Python: React.FC<IconProps> = ({ size = 16, color = 'currentColor', ...props }) => {
    return (
        <svg
            width={size}
            height={size}
        ...
        >
            <defs>
                ...
                <linearGradient>
                    <stop offset={0} stopColor="#7f7f7f" stopOpacity={0.5} />
                    <stop offset={1} stopColor="#7f7f7f" stopOpacity={0} />
                </linearGradient>
                <linearGradient>
                    <stop offset={0} stopColor="#b2b2b2" stopOpacity={0.5} />
