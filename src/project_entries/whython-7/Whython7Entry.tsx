...
function Whython7EntryPage() {
    return (
        <ProjWrapper>
            <Pp>
                This is a currently under development programming language built
                in a completely different manner to previous iterations.
            </Pp>
            <Pp>
                This iteration has Rust-like syntax and compiles down to
                assembly without the use of IL tool such as LLVM. Only the final
                assembling and linking steps are handled by other programs (NASM
                and MSVC respectively).
            </Pp>
        </ProjWrapper>
    )
}
