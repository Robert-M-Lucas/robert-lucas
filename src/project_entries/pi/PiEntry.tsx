...
function PiEntryPage() {
    ...
    <Pp>
        ...
        but I wrote it in C++ to make it as fast as possible. I found that <Pa href="https://www.youtube.com/watch?v=jsYwFizhncE">this
        YouTube video</Pa> gives an excellent explanation of the phenomenon.
    </Pp>
    <Pp>
