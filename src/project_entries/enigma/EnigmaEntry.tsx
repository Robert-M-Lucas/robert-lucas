...
function EnigmaEntryPage() {
    return (
        <ProjWrapper>
            ...
            <Pp>
                I created this project to learn more about how the Enigma
                machine worked so the UI is intentionally bare-bones. It was one
                of the simpler projects I've done however debugging the encoding
                was a nightmare and getting the machine to work backwards when
                you press backspace was difficult too especially with the way
                the rotors turn each other.
            </Pp>
            <Pp>
                For the rotor wiring's, I found strings describing them on
                <Pa href="https://en.wikipedia.org/wiki/Enigma_rotor_details#Rotor_wiring_tables">
                    Wikipedia
                </Pa>{" "}
                and wrote code to convert them into integer arrays representing
                how letters map to each other.
            </Pp>
            <Pimg
                legacyNaturalWidth
                image={python}
            ...
            />
            <Pp>
                To get the encoding forwards you just get the array of the rotor
                you want and get the new number at the current number's index in
                that array. Backwards this is a little more complicated as you
                have to find the index of the input but a simple linear search
                does the trick.
            </Pp>
        </ProjWrapper>
    )
