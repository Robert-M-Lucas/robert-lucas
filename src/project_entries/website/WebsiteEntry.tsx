  ...
  return (
    <ProjWrapper>
      ...
      <Pp>
        ...
        repeated components such as the <Pa href="/projects">projects page</Pa>.
        This also included automatically generating the top part of the page
        you're reading now and making the page you're on change what button on
      ...
      <Pp>
        ...
        <Pa href="https://www.reddit.com/r/place">Reddit's r/place</Pa> in that
        it is a canvas on which any user can draw a single pixel at a time. On
        Reddit there was a lengthy time limit between pixel placements for a
      ...
      <Pp>
        ...
        <Pa href="/chat">Chat page</Pa>. This was made quite similarly to the
