...
function GeometricPatternEntryPage() {
    ...
    <ProjImage image={pattern} alt={"TODO"} caption={"Pattern generated with this project"}/>
    <ProjParagraph>
    ...
    <ProjImage image={pattern2} alt={"TODO"} caption={"Setting the random offsets to 0 demonstrates how it is generated"}/>
    <ProjParagraph>
