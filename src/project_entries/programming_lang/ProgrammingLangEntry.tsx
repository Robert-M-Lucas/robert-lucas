...
function ProgrammingLangEntryPage() {
    ...
    <Pp>
        A new, improved programming language that I created can be found <Pa href="/projects/programming_lang_2">here</Pa>.
    </Pp>
    <Phr/>
    <Pp>
        I am working on making my own interpreted programming language. The most up-to-date information will be in the GitHub's
        <Pa href="https://github.com/Robert-M-Lucas/ProgrammingLanguage/blob/master/README.md">readme</Pa> and the documentation can be
        found in the <Pa href="https://github.com/Robert-M-Lucas/ProgrammingLanguage/wiki">wiki</Pa>.
    </Pp>
    <Pimg legacyNaturalWidth image={tictactoe} alt={"TODO"} caption={"Snippet of Tic Tac Toe written in my programming language (outdated version) with my extension's highlighting"}/>
    <Pp>
        ...
        <Pa href="https://github.com/Robert-M-Lucas/RLC-VSCode-Extension">here</Pa> and is highly recommended if you want to try writing RLC.
    </Pp>
    <Pp>
    ...
    <Pimg image={tictactoe_cmd} alt={"TODO"} caption={"Tic Tac Toe program running"}/>
    <Pp>
