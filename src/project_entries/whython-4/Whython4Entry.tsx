...
function Whython4EntryPage() {
    ...
    <Pp>
        This project is quite similar to my <Pa href="programming_lang_2">second programming language</Pa>, however
    ...
    <Pimg legacyNaturalWidth image={tictactoe} alt={"TODO"} caption={"Tic Tac Toe written in Whython 4"}/>
    </ProjWrapper>;
}