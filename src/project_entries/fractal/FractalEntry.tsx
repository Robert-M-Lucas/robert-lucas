...
function FractalEntryPage() {
    ...
    <Pimg image={one} alt={"TODO"} caption={"Image generated by my program. Originally at 10000x10000 but compressed heavily"}/>
    <Pp>
    ...
    <Pp>
        ...
        <Pul>
            ...
            <Pli>If you zoom in 2x, one pixel should be saved and three new pixels generated instead of a complete regeneration</Pli>
            <Pli>The render feature could save to disk as it runs stopping it from being RAM-limited</Pli>
        </Pul>
    </Pp>
    <Pimg image={two} alt={"TODO"}/>
    <Pimg image={three} alt={"TODO"}/>
    <Pimg image={four} alt={"TODO"}/>
    <Pimg image={five} alt={"TODO"} caption={"An early test of a more optimised screenshot system"}/>
    </ProjWrapper>;
}