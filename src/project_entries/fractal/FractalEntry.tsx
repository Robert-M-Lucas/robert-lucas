...
function FractalEntryPage() {
    return (
        <ProjWrapper>
            ...
            />
            <Pp>
                This program renders and allows you to explore (pan, zoom in,
                etc.) the Mandlebrot and burning ship fractal as well as render
                screenshots at a resolution higher than your monitor. In theory
                you would be able to zoom in infinitely however the double
                precision limit is hit after around 20 zoom ins.
            </Pp>
            <Pp>
                Despite its flaws, this is one of my favourite projects as it
                was my first project in Java and the fractals look beautiful. It
                is also a nice combination of maths and computer science which I
                both like.
            </Pp>
            <Pp>
                This is one of my older projects, however, and I would like to
                redo it with some improvements:
                <Pul>
                    <Pli>Getting around the double precision limit</Pli>
                    <Pli>
                        If you zoom in 2x, one pixel should be saved and three
                        new pixels generated instead of a complete regeneration
                    </Pli>
                    <Pli>
                        The render feature could save to disk as it runs
                        stopping it from being RAM-limited
                    </Pli>
                </Pul>
            </Pp>
