...
function ProgrammingLang2EntryPage() {
    ...
    <ProjImage legacyNaturalWidth image={fizzbuzz} alt={"TODO"} caption={"Fizzbuzz written in this language"}/>
    ...
    <ProjImage legacyNaturalWidth image={lexical_result} alt={"TODO"} caption={"Class holding symbol data"}/>
    <ProjParagraph>
    ...
    <ProjImage legacyNaturalWidth image={handle_line} alt={"TODO"} caption={"Line handling function signature"}/>
    <ProjImage legacyNaturalWidth image={block_handler} alt={"TODO"} caption={"BlockHandler"}/>
    <ProjParagraph>
    ...
    <ProjImage legacyNaturalWidth image={get_reference} alt={"TODO"} caption={"Recursively getting a reference"}/>
    <ProjImage legacyNaturalWidth image={reference_handler} alt={"TODO"}/>
    <ProjImage legacyNaturalWidth image={reference} alt={"TODO"}/>
    <ProjParagraph>
    ...
    <ProjImage legacyNaturalWidth image={int_type} alt={"TODO"} caption={"Integer type"}/>
    <ProjImage legacyNaturalWidth image={int_create} alt={"TODO"} caption={"Creating an integer"}/>
    <ProjImage legacyNaturalWidth image={int_assign} alt={"TODO"} caption={"Creating instruction to assign a value to an integer"}/>
    <ProjParagraph>
    ...
    <ProjImage legacyNaturalWidth image={memory_manager} alt={"TODO"} caption={"Memory Manager"}/>
    <ProjParagraph>
        'Instructions' are classes that create the binary code that will be executed at runtime.
    </ProjParagraph>
    <ProjImage legacyNaturalWidth image={go_to_if} alt={"TODO"} caption={"Instruction that goes to a specified instruction address if the boolean at a specified address is true"}/>
    <ProjParagraph>
        Once compilation has finished, the bytes from the two 'MemoryManager' are saved and/or passed to the interpreter.
    </ProjParagraph>
    <ProjImage legacyNaturalWidth image={save_compiled} alt={"TODO"} caption={"Saving compiled program. Note that 'v_memory' size is saved to so that 'v_memory' and 'p_memory' can be separated when the file is loaded"}/>
    <ProjParagraph>
    ...
    <ProjImage legacyNaturalWidth image={execute} alt={"TODO"} caption={"Snippet of execution code"}/>
    </ProjWrapper>;
}