...
function ProgrammingLang2EntryPage() {
    return <ProjWrapper>
    <Pp>
        I wanted to improve on my <Pa href="/projects/programming_lang">first programming language</Pa> by creating something that is
    ...
    <Pimg legacyNaturalWidth image={fizzbuzz} alt={"TODO"} caption={"Fizzbuzz written in this language"}/>
    <Pimg image={output} alt={"TODO"} caption={"Snippet of the output of the above code"}/>
    <Pp>
    ...
    <Pimg legacyNaturalWidth image={lexical_result} alt={"TODO"} caption={"Class holding symbol data"}/>
    <Pp>
    ...
    <Pimg legacyNaturalWidth image={handle_line} alt={"TODO"} caption={"Line handling function signature"}/>
    <Pimg legacyNaturalWidth image={block_handler} alt={"TODO"} caption={"BlockHandler"}/>
    <Pp>
    ...
    <Pimg legacyNaturalWidth image={get_reference} alt={"TODO"} caption={"Recursively getting a reference"}/>
    ...
    <Pimg legacyNaturalWidth image={int_type} alt={"TODO"} caption={"Integer type"}/>
    <Pimg legacyNaturalWidth image={int_create} alt={"TODO"} caption={"Creating an integer"}/>
    <Pimg legacyNaturalWidth image={int_assign} alt={"TODO"} caption={"Creating instruction to assign a value to an integer"}/>
    <Pp>
    ...
    <Pimg legacyNaturalWidth image={memory_manager} alt={"TODO"} caption={"Memory Manager"}/>
    <Pp>
        'Instructions' are classes that create the binary code that will be executed at runtime.
    </Pp>
    <Pimg legacyNaturalWidth image={go_to_if} alt={"TODO"} caption={"Instruction that goes to a specified instruction address if the boolean at a specified address is true"}/>
    <Pp>
        Once compilation has finished, the bytes from the two 'MemoryManager' are saved and/or passed to the interpreter.
    </Pp>
    <Pimg legacyNaturalWidth image={save_compiled} alt={"TODO"} caption={"Saving compiled program. Note that 'v_memory' size is saved to so that 'v_memory' and 'p_memory' can be separated when the file is loaded"}/>
    <Pp>
    ...
    <Pimg legacyNaturalWidth image={execute} alt={"TODO"} caption={"Snippet of execution code"}/>
    </ProjWrapper>;
}