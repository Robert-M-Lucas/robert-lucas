...
function ChessEntryPage() {
    ...
    <ProjImage image={dolly_zoom} alt={"TODO"} caption={"The dolly zoom equation I used."} source={{name: "Wikipedia", url: "https://en.wikipedia.org/wiki/Dolly_zoom#Calculating_distances"}}/>
    ...
    <ProjImage image={minimax} alt={"TODO"} caption={"Minimax diagram - AI would be maximising and player would be minimising."} source={{name: "Medium", url: "https://medium.com/@SereneBiologist/the-anatomy-of-a-chess-ai-2087d0d565"}}/>
    ...
    <ProjImage image={alphabeta} alt={"TODO"} caption={"Alpha-Beta pruning diagram"} source={{name: "Medium", url: "https://medium.com/@SereneBiologist/the-anatomy-of-a-chess-ai-2087d0d565"}}/>
